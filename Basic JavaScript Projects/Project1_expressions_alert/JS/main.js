...
var C = "I do not know what to do with our dog. " + "She has inflammatory bowel disease, and when she has kibble of any kind, she has liquid diarrhea. ";  //setting a variable with a concatenated string
var D = "We have been feeding \"The Farmer\'s Dog\", which nearly solves the problem, but she steals food because she is so hungry, and has lost at least five pounds in about a month. ";  //setting a variable with a string
var C = C.fontcolor("Blue");             //setting the font color for the variable C
var D = D.fontcolor("Orange");           //setting the font color for the variable D
document.write(C + D);                   //displaying concatenated variable C + D with blue and orange font
